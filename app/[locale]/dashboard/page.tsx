        ...
        <div className="welcome-content mb-5 flex gap-4">
          ...
          <div className="welcome-text">
            ...
            <p className="text-[13px] leading-[1.5] text-[var(--text-secondary)]">
              Your dashboard is ready. Start by creating groups, assigning tasks, or scheduling events to see your widgets come alive.
            </p>
          </div>
        </div>
      ...
      <div className="dashboard-grid mt-4 grid gap-4 xl:grid-cols-2">
        <section className="panel rounded-[12px] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-5">
          ...
          <div className="empty-state flex flex-col items-center justify-center px-5 py-10 text-center">
            ...
            <p className="empty-text mb-1 text-sm text-[var(--text-secondary)]">No recent activity</p>
            <p className="empty-subtext text-xs text-[var(--text-tertiary)]">Actions from your team will appear here</p>
          </div>
        </section>
        ...
        <section className="panel rounded-[12px] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-5">
          ...
          <div className="quick-actions space-y-1">
            {[
              {label: 'Create group', desc: 'Add a new team group', icon: UserPlus},
              {label: 'Add task', desc: 'Create a new task', icon: ListTodo},
              {label: 'Schedule event', desc: 'Add to calendar', icon: CalendarPlus},
              {label: 'Create post', desc: 'Write a new post', icon: FileUp}
            ].map((item) => {
